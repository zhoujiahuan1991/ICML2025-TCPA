...
data_dir = "/data/dataset/liuzichen/VTAB"  # TODO: setup the data_dir to put the the data to, the DATA.DATAPATH value in config
...
# caltech101
# dataset_builder = tfds.builder("caltech101:3.0.2", data_dir=data_dir)
...
dataset_builder.download_and_prepare()
print("cifar100:3.0.2 dataset is downloaded and prepared")

# clevr
dataset_builder = tfds.builder("clevr:3.1.0", data_dir=data_dir)
dataset_builder.download_and_prepare()
print("clevr:3.1.0 dataset is downloaded and prepared")


# dmlab
dataset_builder = tfds.builder("dmlab:2.0.1", data_dir=data_dir)
dataset_builder.download_and_prepare()
print("dmlab:2.0.1 dataset is downloaded and prepared")

# dsprites
dataset_builder = tfds.builder("dsprites:2.0.0", data_dir=data_dir)
dataset_builder.download_and_prepare()
print("dsprites:2.0.0 dataset is downloaded and prepared")

# dtd
dataset_builder = tfds.builder("dtd:3.0.1", data_dir=data_dir)
dataset_builder.download_and_prepare()
print("dtd:3.0.1 dataset is downloaded and prepared")
